...
public class Work {
    ...
    //CompletableFuture<Void> - просто выполнит действие, не возвращая результата
    //runAsync() - возвращает CompletableFuture<Void>
    //get() - возвращает Void
    ...
    //CompletableFuture<T> - вернет результат CompletableFuture<T>
    //supplyAsync() - возвращает CompletableFuture<T>
    //get() - возвращает T
    ...
    //CompletableFuture<Void> - просто выполнит действие, не возвращая результата
    //thenRun() - метод ничего не возвращает, а позволяет выполнить задачу типа Runnable после выполнения асинхронной задачи.
    ...
    //CompletableFuture<T> - вернет результат CompletableFuture<T>
    //thenAccept() - метод имеет доступ к результату CompletableFuture.
    ...
    //get() - результат преобразования станет доступным только при вызове get()
    ...
    //thenCompose() - метод используется, если действия зависимы. Т.е. сначала должно выполниться одно, а только потом другое
